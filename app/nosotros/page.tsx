      ...
      <main className="section-shell section-gap">
        <div className="max-w-3xl">
          ...
          <h1 className="display-title mt-6 text-balance">
            Estética facial y corporal con una atención verdaderamente cercana.
          </h1>
          <p className="prose-copy mt-6">
            En La Maison combinamos tecnología de vanguardia con planes
            personalizados para acompañarte hacia tu mejor versión. Una
            experiencia cálida y profesional en el corazón de Palermo Soho.
          </p>
        </div>
