    ...
    <section className="section-gap pt-0">
      <div className="section-shell">
        <div className="card-surface overflow-hidden lg:grid lg:grid-cols-[0.9fr_1.1fr]">
          <div className="relative min-h-80 bg-[radial-gradient(circle_at_top_left,rgba(168,52,102,0.14),transparent_34%),linear-gradient(145deg,rgba(255,255,255,0.96),rgba(243,220,230,0.3))]">
            <Image
              src="/images/team/cosmetologa.webp"
              alt="Profesional de La Maison Estética"
              fill
